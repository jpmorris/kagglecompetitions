...
#build our formula
#formulaCount <- count ~  season + weather + atemp + humidity + hour + daypart +day + work # original code scores 0.49650
formulaCount <- count ~  season + weather + atemp + humidity +hour + daypart + day + work + sunday + saturday # adding sunday and saturday scores 0.49734
